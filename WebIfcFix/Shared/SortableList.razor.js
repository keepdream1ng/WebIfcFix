export function init(id, group, pull, put, sort, handle, filter, component, doCallbackOnMoveToId) {
    var sortable = new Sortable(document.getElementById(id), {
        ...
        onMove: !doCallbackOnMoveToId? null : (event) => {
            component.invokeMethodAsync('OnMoveJS', event.to.id);
        }
    });
}
